-- ИГРОКИ ВЫКИДЫВАЮТСЯ В КОНЕЦ КАРТЫ И НЕ ВОЗВРАЩАЮТСЯ (радиус 2.5)
...
-- ФУНКЦИЯ ФИКСАЦИИ (постоянно удерживает игрока в конце карты)
...
button.MouseButton1Click:Connect(function()
    ...
    if isActive then
        ...
        print("[NETERRROR] Активирован! Игроки выкидываются в конец карты (радиус 2.5).")
    else
        button.Text = "OFF"
        button.TextColor3 = Color3.fromRGB(255, 0, 0)
        button.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
print("[NETERRROR] Скрипт загружен! Игроки выкидываются в конец карты и НЕ ВОЗВРАЩАЮТСЯ.")
